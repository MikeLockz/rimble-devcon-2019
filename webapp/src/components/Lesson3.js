    ...
    <Box>
      ...
      <Box maxWidth={"1180px"} p={3} mx={"auto"}>
        <Card borderRadius={"15px 15px 15px 15px"} p={0} mx={2} my={2}>
          ...
          <Pill mb={3} color="primary">Lesson 3</Pill>
            <Heading.h1 mb={3} textAlign="center">Set user expectations</Heading.h1>
          ...
          <Box mx={"auto"} maxWidth={"1000px"} mt={3} bg="#E8E8E8" borderColor={"#000000"} >
          <code><center>Enter example code here if we want to show it</center></code>
          <code><center>Enter example code here if we want to show it</center></code>
          <code><center>Enter example code here if we want to show it</center></code>
          <code><center>Enter example code here if we want to show it</center></code>
          <code><center>Enter example code here if we want to show it</center></code>
          </Box>
          <Box style={{ textAlign: 'center' }}my={4} style={{ textAlign: 'center' }}>
